                    ...
                    <div class="flex items-center justify-between p-4 bg-gray-50 rounded-lg border">
                        ...
                        <div class="flex items-center space-x-2">
                            <a href="{{ route('certificates.download', $certificate) }}"
                               class="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md text-white bg-[#21235F] hover:bg-[#1a1d4a] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#21235F] transition duration-150 ease-in-out">
                                Pobierz
                            </a>
                            <a href="{{ route('certificates.show', $certificate) }}"
                               class="inline-flex items-center px-4 py-2 border border-[#21235F] text-sm font-medium rounded-md text-[#21235F] bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#21235F] transition duration-150 ease-in-out">
                                Podgląd
                            </a>
                        </div>
                    </div>
