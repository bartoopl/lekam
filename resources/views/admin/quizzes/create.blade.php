                    ...
                    <div class="form-section">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
                            <div>
                                ...
                                <input type="number" name="questions_to_draw" id="questions_to_draw" value="{{ old('questions_to_draw') }}" min="1"
                            ...
                            <div>
                                ...
                                <input type="number" name="min_correct_answers" id="min_correct_answers" value="{{ old('min_correct_answers') }}" min="1"
