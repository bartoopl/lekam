...
<div class="py-12">
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        ...
        <div class="course-info">
            <h3 class="text-lg font-medium text-gray-900 mb-2">Dodawanie pytania dla kursu:</h3>
        ...
        <div class="form-container">
            <h2 class="form-title">Dodaj Nowe Pytanie</h2>
            
            <form action="{{ route('admin.questions.store', [$course, $quiz]) }}" method="POST">
                @csrf
                ...
                <div class="grid grid-cols-1 gap-6">
                    ...
                    <div>
                        ...
                        <textarea name="question" id="question" rows="4" required
                            class="mt-1 block w-full form-input" placeholder="Wpisz treść pytania...">{{ old('question') }}</textarea>
                        @error('question')
                        ...
                        <div class="space-y-3">
                            <div class="flex items-center">
                                <input type="radio" name="type" id="type_single" value="single_choice" 
                                    {{ old('type') === 'single_choice' ? 'checked' : '' }} required
                        ...
                        <div class="space-y-3">
                            <div class="flex items-center">
                                <input type="radio" name="correct_answers[]" id="correct_true" value="true" 
                                    {{ in_array('true', old('correct_answers', [])) ? 'checked' : '' }}
                                    class="h-4 w-4 text-green-600 focus:ring-green-500 border-gray-300">
                            ...
                            <div class="flex items-center">
                                <input type="radio" name="correct_answers[]" id="correct_false" value="false" 
                                    {{ in_array('false', old('correct_answers', [])) ? 'checked' : '' }}
                                    class="h-4 w-4 text-green-600 focus:ring-green-500 border-gray-300">
