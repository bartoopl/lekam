                        ...
                        <div class="grid grid-cols-1 gap-6">
                            ...
                            <div>
                                ...
                                <textarea name="bio" id="bio" rows="4"
                                    class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500">{{ old('bio', $instructor->bio) }}</textarea>
                                @error('bio')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            @if($instructor->photo)
                                <div>
                                    <label class="block text-sm font-medium text-gray-700">Obecne zdjęcie</label>
                            ...
                            <div>
                                <label for="photo" class="block text-sm font-medium text-gray-700">
                                    {{ $instructor->photo ? 'Zmień zdjęcie (opcjonalnie)' : 'Zdjęcie (opcjonalnie)' }}
                                </label>
                            ...
                            <div class="flex justify-end space-x-3">
                                <a href="{{ route('admin.instructors.show', $instructor) }}" class="bg-gray-300 text-gray-700 px-4 py-2 rounded-lg hover:bg-gray-400 transition duration-300">
                                    Anuluj
                                </a>
                                <button type="submit" class="btn btn-primary">
                                    Zaktualizuj wykładowcę
                                </button>
                            </div>
                        </div>
                    </form>
